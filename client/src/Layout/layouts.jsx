     ...
     return (
          <div className=''>
               <div className='container mx-auto '>
                    ...
                    <div className="navbar bg-orange-600 font-bold text-white">
               ...
               <div className='container-fluid bg-base-200'>
                    <footer className="footer p-10 bg-base-200 text-base-content container mx-auto">
                              <aside>
                                   ...
                                   <p className='text-base font-semibold'>HD <span className='text-red-600 uppercase'>Mert</span> Industries Ltd.<br />Providing reliable ecommerce since 2024</p>
                              ...
                              <nav>
                                   ...
                                   <a className="link link-hover text-base font-semibold">Branding</a>
                                   <a className="link link-hover text-base font-semibold">Design</a>
                                   <a className="link link-hover text-base font-semibold">Marketing</a>
                                   <a className="link link-hover text-base font-semibold">Advertisement</a>
                              </nav>
                              <nav>
